...
<body>
    ...
    <div class="main">
        <div class="main_box">
            ...
            <div class="center" style="word-spacing: .52em;"><input type="text" class="textin" style="width: 18em;" value="<?php echo $mostrar['nombre'] ?>"> quien cursa el semestre <input type="text" class="textin" style="width: 4em;" value="<?php echo $mostrar['grupo'] ?>"> Por medio de este </div>
